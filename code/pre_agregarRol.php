...
<body>
	...
	<section class="full-box dashboard-contentPage">
        ...
        <div class="page-header">
			  <h1 class="text-titles text-center">Agregar Rol Al Sistema</h1>
        </div>
        <div class="container" style="max-width: 630px;">
            <form action="neg_agregarRol.php" method="POST" autocomplete="off">
                <div class="form-group">
                    <label>Nombre del Rol</label>
                    <input type="text" class="form-control" name="rolNombre" placeholder="Nombre del rol" + required>
                </div>
                <center>
