...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles text-center text-capitalize">Registrar categoria</h1>
			</div>
			...
			<div class="container" style="max-width: 630px;">
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <strong>¡Ups!</strong> La categoria indicada ya existe. Está intentando registrar una categoria que ya está registrada.
                    </div>
                <?php
                    }
                ?>
                ...
                <form name="registro_categoria"  method="POST" action="neg_registrarCategoria.php"  class="register-container px-md-5" autocomplete="off">
                    <div class="form-group label-floating">
                        ...
                        onchange="validarNombre(this.value)" placeholder="Ingrese el Nombre de la categoria" required autofocus>
                    </div>                    
                    <div class="form-group label-floating">
