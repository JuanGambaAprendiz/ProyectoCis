	...
	<section class="full-box dashboard-contentPage">
        ...
        <form name="registro"  method="POST" action="neg_editarDatosUsuario.php"  class="register-container px-md-5" autocomplete="off">
                ...
                <div class="form-group label-floating">
                    ...
                    <input class="form-control" value="<?php echo $_SESSION['usuarioTelefono']; ?>"  id="UserTel" name="usuarioTelefono" type="text" pattern="[a-zA-Z0-9 /]+" placeholder="Ingrese el Teléfono de Contacto del Usuario" + required>                    
                </div>
                <br>
                <center>
