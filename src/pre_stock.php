...
<head>
	...
	?>
	<title>Stock - Administrador</title>
</head>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid" style="margin-top: 15px;">
			<div class="page-header">
			  <h1 class="text-titles"><span class="text-info">Stock</span> - ADMINISTRADOR</h1>
			</div>
		</div>
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles text-center text-capitalize">Actividad y movimiento del inventiario</h1>
			</div>
			<?php
			...
			<div class="panel panel-default">
				<div class="panel-body">
					...
					<div class="table-responsive">
						...
						<caption>Lista de moviminetos realizados de los productos registrados</caption>
						<thead class="">
							<tr class="warning">								
