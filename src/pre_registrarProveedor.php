...
<body>
	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles text-center text-capitalize">Registrar Proveedor</h1>
			</div>
			...
			<div class="container" style="max-width: 630px;">
                ...
                ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <strong>¡Ups!</strong> El Proveedor indicado ya existe. Está intentando registrar un proveedor que ya está registrado.
                    </div>
                <?php
                    }
                ?>
                ...
                <form name="registro_proveedor"  method="POST" action="neg_registrarProveedor.php"  class="register-container px-md-5" autocomplete="off">
                    <div class="form-group label-floating">
                        ...
                        onchange="validarNombre(this.value)" placeholder="Ingrese el Nombre y Apellido del Proveedor" required autofocus>
                    </div>                    
                    <div class="form-group label-floating">
                        ...
                        placeholder="Ingrese el Teléfono de contacto del Proveedor" + required>
                    </div>
                    <div class="form-group label-floating">
                        <label class="control-label" for="proveedorDireccion">Dirección*</label>
                        <input class="form-control"  id="proveedorDireccion" name="direccion" type="text" placeholder="Ingrese el Dirección del Proveedor" + required>
                    </div>                    
                    <br>
